    ...
    <x-slot name="header">
        <div class="flex justify-between items-center bg-gradient-to-r from-blue-600 via-cyan-600 to-teal-600 p-6 rounded-lg shadow-lg">
            <div>
                ...
                <p class="text-blue-100 mt-1">Administra el catálogo de productos del restaurante</p>
            </div>
                ...
                <div class="p-6">
                    <form method="GET" action="{{ route('products.index') }}">
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div>
                                <label for="available" class="block text-sm font-medium text-gray-700">Estado</label>
